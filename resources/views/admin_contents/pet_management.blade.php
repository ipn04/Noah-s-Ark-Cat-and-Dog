<x-app-layout>
    ...
    <section class="sm:ml-64 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
            ...
            <div class="container mx-auto">
                <!-- 2 columns on small screens, 3 columns on medium screens, 4 columns on large screens -->
                <div id="Container" class="grid grid-cols-1  p-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 px-8">
                    <!-- Column 1 -->

                    @if($pets->isNotEmpty())
                    @foreach($pets as $pet)
                    <div class="flex flex-col items-center bg-white shadow rounded-lg hover:shadow-md relative" data-name="{{ $pet->pet_name }}">
                        <img src="{{ asset('storage/images/' . $pet->dropzone_file) }}" alt="Pet Image" class="rounded-full h-20 w-20 object-cover">
                ...
                @endif
                    ...
                    <div class="flex-1 flex items-center space-x-2">
                        <h5>
                            ...
                            <span class="dark:text-white">{{$petCount}}</span>
                        </h5>
            ...
            -->
                ...
                <div class="overflow-x-auto">
                    <!--
                    <table id="petsTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <!--
                        <tbody> 
                            @if($pets->isNotEmpty())
                                @foreach($pets as $pet)
                                    <tr class="petRow border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">                   
            ...
            <div id="category-body" class="hidden" aria-labelledby="category-heading">
                <div class="py-2 font-light border-b border-gray-200 dark:border-gray-600">
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-center">
                            <input id="logitech" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
