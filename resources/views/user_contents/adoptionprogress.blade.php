<x-app-layout>
    ...
    <section class="sm:ml-64 mb-5 dark:bg-gray-900 p-2 antialiased">
        ...
        <div class = "flex items-center  py-5  justify-center">
            <div class = "grid grid-cols-1 max-w-screen-lg px-5 py-3 bg-white rounded-2xl shadow-md lg:grid-cols-7 gap-2">
                <div>
                <div class = "flex items-center justify-center ">
                    <div class = "flex items-center justify-center rounded-full w-16 h-16 bg-red-500">
                ...
                <h1 class = "text-center py-2 ">Application Submitted</h1>
                </div>
                <div>
                    <div>
                    <div class = "flex items-center justify-center">
                    ...
                    <h1 class = "text-center py-2 ">Application Validated</h1>
                </div>
                </div>
                <div>
                    <div>
                    ...
                    <h1 class = "text-center py-2">Schedule Interview</h1>
                    </div>
                </div>
                <div>
                    <div>
                    ...
                    <h1 class = "text-center py-2">Interview</h1>
                    </div>
                </div>
                <div>
                    <div>
                    ...
                    <h1 class = "text-center py-2">Final Decision</h1>
                    </div>
                </div>
                <div>
                    <div>
                    ...
                    <h1 class = "text-center py-2">Schedule Pickup</h1>
                    </div>
                </div>
                <div>
                    <div>
                    ...
                    <h1 class = "text-center py-2">Pet Pickup</h1>
                    </div>
                </div>
            </div>
        </div>
