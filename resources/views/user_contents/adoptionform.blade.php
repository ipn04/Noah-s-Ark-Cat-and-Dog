        ...
        @if ($pets && is_object($pets))
            ...
            <div class = "flex gap-2  py-4 px-10">
                ...
                <div class = "flex items-center justify-center">
                    ...
                    href = "{{ route('user.pet', $pets->id) }}"class=" hover:text-red-500 font-bold text-lg">{{ $pets->pet_name }}</a>
                <div class = "flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="max-w-screen-xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-2 px-4 py-4 gap-8 w-full">
                    <div class = "bg-white p-10 max-w-2xl shadow-lg rounded-2xl items-center justify-center flex">
                        <form method="POST" action="{{ route('send.form', ['petId' => $petId]) }}" class="max-w-2xl"
                            ...
                            <div id="section1" class="block">
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="first_question" class="block mt-1 w-full" type="text"
                                        name="first_question" :value="old('first_question')" required
                                        autocomplete="first_question" />
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-select id="sixth_question" name="sixth_question" :value="old('sixth_question')" required
                                        autocomplete="sixth_question">
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </x-select>
                                </div>
                                <div class = "mt-2">
                                    ...
                                    <x-select id="sevent_question" name="sevent_question" :value="old('sevent_question')" required
                                        autocomplete="sevent_question">
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </x-select>
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="tenth_question" class="block mt-1 w-full" type="text"
                                        name="tenth_question" :value="old('tenth_question')" required
                                        autocomplete="tenth_question" />
                                </div>
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="eleventh_question" class="block mt-1 w-full" type="text"
                                        name="eleventh_question" :value="old('eleventh_question')" required
                                        autocomplete="eleventh_question" />
                                </div>

                                <div class = "mt-3">
                                    <x-primary-button type="button"
                                        onclick="showSection(1, 2)">Next</x-primary-button>
                                </div>
                            </div>
                            ...
                            <div id="section2" class="hidden">
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="twelfth_question" class="block mt-1 w-full" type="text"
                                        name="twelfth_question" :value="old('twelfth_question')" required
                                        autocomplete="twelfth_question" />
                                </div>
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="thirteenth_question" class="block mt-1 w-full" type="text"
                                        name="thirteenth_question" :value="old('thirteenth_question')" required
                                        autocomplete="thirteenth_question" />
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="fourteenth_question" class="block mt-1 w-full" type="text"
                                        name="fourteenth_question" :value="old('fourteenth_question')" required
                                        autocomplete="fourteenth_question" />
                                </div>
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="fifteenth_question" class="block mt-1 w-full" type="text"
                                        name="fifteenth_question" :value="old('fifteenth_question')" required
                                        autocomplete="fifteenth_question" />
                                </div>
                                <div class = "mt-2">
                                    <x-input-label for="seventeenth_question" :value="__('What type of building do you live in?
                                                            ')" />
                                    <x-select id="seventeenth_question" name="seventeenth_question" :value="old('seventeenth_question')"
                                        required autocomplete="seventeenth_question">
                                ...
                                <div class = "mt-2">
                                    <x-input-label for="eighteenth_question" :value="__('Do you rent?
                                                            ')" />
                                    <x-select id="eighteenth_question" name="eighteenth_question" :value="old('eighteenth_question')"
                                        required autocomplete="eighteenth_question">
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </x-select>
                                ...
                                <div class = "mt-2">
                                    ...
                                    <x-text-input id="nineteenth_question" class="block mt-1 w-full" type="text"
                                        name="nineteenth_question" :value="old('nineteenth_question')" required
                                        autocomplete="nineteenth_question" />
                                ...
                                @if ($pets->pet_type === 'Dog')
                                    <div class = "mt-2">
                                        ...
                                        <x-select id="twentieth_question" name="twentieth_question" :value="old('twentieth_question')"
                                            required autocomplete="twentieth_question">
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </x-select>
                                    ...
                                    <div class = "mt-2">
                                        <x-input-label for="twentyfirst_question" :value="__('How much time will your dog spend in the yard?
                                                                        ')" />
                                        <x-text-input id="twentyfirst_question" class="block mt-1 w-full"
                                            type="text" name="twentyfirst_question" :value="old('twentyfirst_question')" required
                                            autocomplete="twentyfirst_question" />

                                    </div>
                                    <div class = "mt-2">
                                        <x-input-label for="twentysecond_question" :value="__(
                                            'Are you prepared to walk and potty train your dog?                            ',
                                        )" />
                                        <x-select id="twentysecond_question" name="twentysecond_question"
                                            :value="old('twentysecond_question')" required autocomplete="twentysecond_question">
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </x-select>
                                    ...
                                    <div class = "mt-2">
                                        <x-input-label for="twentythird_question" :value="__('Are you prepared to manage chewing, marking, excessive barking, etc?
                                                                        ')" />
                                        <x-select id="twentythird_question" name="twentythird_question"
                                            :value="old('twentythird_question')" required autocomplete="twentythird_question">
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </x-select>
                                    </div>
                                @elseif($pets->pet_type === 'Cat')
                                    ...
                                    <div class = "mt-2">
                                        <x-input-label for="twentysecond_question" :value="__(
                                            'Are you prepared for the unpleasant odor of cat feces?                            ',
                                        )" />
                                        <x-select id="twentysecond_question" name="twentysecond_question"
                                            :value="old('twentysecond_question')" required autocomplete="twentysecond_question">
                                            <option value="Yes">Yes</option>
                                ...
                                <div class = "flex gap-2 mt-3">
                                    <x-primary-button type="button" onclick="showSection(2, 1)"
                                        class="bg-blue-500 text-white px-4 py-2 rounded mr-2">Previous</x-primary-button>
                                    <x-primary-button type="button" onclick="showSection(2, 3)"
                                        class="bg-blue-500 text-white px-4 py-2 rounded">Next</x-primary-button>
                                </div>
                            ...
                            <div id="section3" class="hidden">
                                ...
                                <div class="px-4 py-3">
                                    <div id="image-preview"
                                        ...
                                        <label for="upload" class="cursor-pointer">
                                            ...
                                            <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Upload your
                                                Valid ID</h5>
                                            <p class="font-normal text-sm text-gray-400 md:px-6">Choose photo size
                                                should be less than <b class="text-gray-600">2mb</b></p>
                                ...
                                <div class="px-4 py-3">
                                    <div id="image-preview2"
                                        class="max-w-sm p-6 mb-4 bg-gray-100 border-dashed border-2 border-gray-400 rounded-lg items-center mx-auto text-center cursor-pointer">
                                        <input id="upload2" name="upload2" type="file" class="hidden"
                                            accept="image/*" />
                                ...
                                <div class = "flex gap-2 mt-3">
                                    <x-primary-button type="button"
                                        onclick="showSection(3, 2)">Previous</x-primary-button>
                            ...
                            <div class="w-full">
                                <div class="overflow-hidden w-full rounded-t-2xl">
                                    <img src="{{ asset('storage/images/' . $pets->dropzone_file) }}"
                                        class=" w-full object-cover" style ="max-height: 30em" />
                                        ...
                                        <div
                                            ...
                                            <div class="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <p class="text-base">{{ $pets->breed }} · {{ $pets->age }}yr
                                                    </p>
                                                </div>
