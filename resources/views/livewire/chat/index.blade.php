                        ...
                        <div class="relative  max-w-6xl mx-auto bg-white shadow-lg rounded-lg">
                            ...
                            <div class="py-3 px-5">
                                ...
                                <form role="search" class="flex items-center">
                                    <label for="simple-search" class="sr-only">Search User</label>
                                    <div class="relative w-full">
                                        ...
                                        <input type="text" id="simple-search" placeholder="Search User"
                                            name="search" required=""
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                                    </div>
                                </form>
                                <!-- Chat list -->
                                                ...
                                                <div class="flex items-center">
                                                    <div class = "flex items-center relative">
                                                        ...
                                                        <div
                                                            class="absolute bottom-0 right-0 text-white rounded-full w-8 h-8 flex items-center justify-center text-xs pointer-events-none
                                                                @if ($thread->concern == 'Adoption') bg-red-500
                                                    ...
                                                    <div class = "ps-3 max-w-md">
                                                        ...
                                                        <div class="flex items-center text-base truncate">
                                                            <p class="text-sm">
                                                                {{ $thread->isCurrentUser ? 'You: ' : $thread->user->firstname . ': ' }}
                                                            </p>
                                                            <p class="text-sm">{{ $thread->content }}</p>
                                                        </div>
                                                        <span
                                                            class="text-xs">{{ \Carbon\Carbon::parse($thread->created_at)->format('M d, Y h:iA') }}
                                                            @if ($thread->unreadCount > 0)
                                                                <div class="text-xs text-red-500">
                                                                    {{ $thread->unreadCount }} unread messages</div>
                                                            @endif
                                                    </div>
                                                </div>
                                            </button>
                    ...
                    <div class="max-h-full">
                        ...
                        <div class="relative max-w-6xl bg-white mx-auto shadow-md rounded-xl">
                            ...
                            <div class="py-5 px-5">
                                        ...
                                        <div class="relative p-4 w-full max-w-2xl max-h-full">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 md:px-5 space-y-4">
                                                    <div>
                                                        <p
                                                            class="text-lg leading-relaxed text-gray-500 py-2 dark:text-gray-400">
                                                            In order to send a message, click this button.
                                                        </p>
                                                        <button
                                                            class="flex items-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  text-base"
                                                            type="button">
                                                            <svg class="h-4 w-4 text-white mx-0.5" fill="none"
                                                                viewBox="0 0 24 24" stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <div
                                                        class="flex items-center mt-4  border-t border-gray-200 rounded-b dark:border-gray-600">

                                                    </div>

                                                    <p
                                                        class="text-xl font-bold leading-relaxed text-gray-500 dark:text-gray-400">
                                                        Message Icon Guidelines:
                                                    </p>
                                                    <div class = "flex items-center relative">

                                                        <div class=" text-white rounded-full w-10 h-10 flex items-center justify-center text-xs pointer-events-none
                                                               bg-red-500
                                                                ">
                                                            <div class="flex items-center justify-center">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <div class = "flex items-center relative">
                                                        ...
                                                        <h1 class = "ps-2">Collaborations</h1>
                                                    </div>
                                                    <div class = "flex items-center relative">
                                                ...
                                                <form method="POST" action="{{ route('messages.send') }}"
                                                    ...
                                                    <div class="col-span-2 py-2">
                                                        ...
                                                        <textarea id="content" name="content" rows="4"
                                                            ...
                                                            placeholder="Write your message concern here" required></textarea>
                                                    </div>
                                ...
                                @foreach ($threads as $thread)
                                    <div wire:click="markAsReadAndNavigate({{ $thread->id }})"
                                        class="divide-y p-3 divide-black-900 hover:bg-gray-100 hover:rounded-lg px-2">
                                        <!-- User -->
                                        {{-- <a href="{{ route('chat', ['messageId' => $thread->id]) }}"> --}}
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class = "ps-3 max-w-md">
                                                    ...
                                                    <div class="text-base truncate">
                                                        <div class="flex items-center text-base truncate">
                                                            <p class="text-sm">
                                                                {{ $thread->isCurrentUser ? 'You: ' : 'Noah\'s Ark :' }}
                                                            </p>
                                                            <p class="text-sm">{{ $thread->content }}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if ($thread->unreadCount > 0)
                                                        <div class="text-xs text-red-500">{{ $thread->unreadCount }}
                                                            unread messages</div>
                                                    @endif
                                                </div>
                                            </div>
