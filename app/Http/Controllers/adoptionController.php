...
class adoptionController extends Controller
{
    ...
    public function userApplication() {
        ...
        return view('user_contents.applications',  compact('scheduleCount','schedules','answers', 'volunteer', 'totalApplicationsForUser', 'totalPendingApplicationsForUser', 'approvedApplicationForUser', 'rejectedApplicationForUser', 'volunteerPending', 'volunteerApproved'));
    }
