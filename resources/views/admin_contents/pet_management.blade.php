                                        ...
                                        <td class="items-center gap-1  hidden lg:table-cell">
                                            @if ($pets->isNotEmpty())
                                                ...
                                                <button type="button"
                                                    data-modal-target="delete-modal-{{ $pet->id }}"
                                                    data-modal-toggle="delete-modal-{{ $pet->id }}"
                                                    class="py-2 px-3 text-sm font-medium text-center text-white bg-green-500 hover:bg-green-600 rounded-lg shadow-md">
            ...
            <div id="adoption-body" class="hidden" aria-labelledby="adoption-heading">
                <div class="py-2 font-light border-b border-gray-200 dark:border-gray-600">
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-center">
                            <input id="filter_adopted" type="checkbox" value="Adopted"
                                class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                            <label for="filter_adopted"
                                class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Adopted</label>
                        </li>
                    </ul>
                </div>
            </div>
