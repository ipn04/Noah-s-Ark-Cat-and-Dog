                        ...
                        <div class="relative  max-w-6xl mx-auto bg-white shadow-lg rounded-lg">
                            ...
                            <div class="py-3 px-5">
                                ...
                                @foreach ($threads as $thread)
                                    <div class="message-item divide-y divide-black-900 hover:bg-gray-100 hover:rounded-lg mt-2 px-2"
                                            ...
                                            <button class="w-full text-left py-2">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div class = "ps-3">
                                                        ...
                                                        <div class="text-base">{{ $thread->content }} • <span
                    ...
                    <div class="max-h-full">
                        ...
                        <div class="relative max-w-6xl bg-white mx-auto shadow-md rounded-xl">
                            ...
                            <div class="py-5 px-5">
                                ...
                                <!-- Chat list -->
                                @foreach ($threads as $thread)
                                    <div class="divide-y p-3 divide-black-900 hover:bg-gray-100 hover:rounded-lg px-2">
                                        <!-- User -->
                                        <a href="{{ route('chat', ['messageId' => $thread->id]) }}">
                                            <button class="w-full text-left py-2">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class ="ps-3">
                                                        <h4 class="text-base font-semibold text-gray-600">Noah's Ark
                                                            Dog and Cat Shelter</h4>
                                                        <div class="text-base">You: {{ $thread->content }} <span
                                                                class="text-xs">•
                                                                {{ \Carbon\Carbon::parse($thread->created_at)->format('h:i a') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </button>
