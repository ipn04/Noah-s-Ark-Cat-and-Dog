        ...
        <ul class="space-y-3 font-medium">
            ...
            <li>
                <a href="{{ route('user.dashboard') }}"
                    ...
                    <svg class="
                        @if (Route::is('user.dashboard')) flex-shrink-0 w-5 h-5 text-red-600 transition duration-75 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-white
                        @else
            ...
            <li>
                <a href="{{ route('user.applications') }}"
                    ...
                    flex items-center p-2 hover:text-gray-800 text-gray-500 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group @endif">
                    <svg class="
                        @if (Route::is('user.applications')) flex-shrink-0 w-5 h-5 text-red-600 transition duration-75 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-white
                        @else
                        flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-white @endif"
