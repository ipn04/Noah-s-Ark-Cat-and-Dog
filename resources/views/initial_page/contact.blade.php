        ...
        <div
            ...
            <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                <div class="lg:w-1/2 px-6">
                    ...
                    <a href = "https://www.google.com/maps?ll=15.256863,120.582953&z=16&t=m&hl=en&gl=US&mapclient=embed&cid=15003899520905678324" class="mt-1 text-red-500 ">Sitio Irung Brgy. Tabun, Mabalacat, Philippines</a>
                    <h2 class="title-font font-semibold pt-5 text-gray-900 tracking-widest text-xs">OPENING HOURS </h2>
                    <p class="mt-1">7am - 5pm Weekdays</p>
                </div>
                <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                    <a class="text-red-500 leading-relaxed">noahsarkph@gmail.com</a>
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                    <p class="leading-relaxed">+639338240324</p>
