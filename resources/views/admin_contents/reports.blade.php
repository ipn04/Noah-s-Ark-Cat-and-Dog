                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    backgroundColor: [
                                        'rgba(255, 0, 0, 0.45)',
                                        'rgba(253, 255, 190, 1)',
                                        'rgba(255, 150, 150, 1)', 'rgba(255, 210, 210, 1)', 'rgba(255, 255, 180, 1)', 'rgba(230, 190, 160, 1)', 'rgba(190, 230, 190, 1)',
                                        'rgba(255, 140, 140, 1)', 'rgba(255, 190, 190, 1)', 'rgba(220, 180, 150, 1)', 'rgba(200, 255, 200, 1)', 'rgba(140, 200, 140, 1)',

                                    ],
                                    borderColor: [
                                        'rgba(255, 0, 0, 0.75)',
                                        'rgba(249, 255, 0, 0.75)',
                                        'rgba(255, 170, 170, 1)', 'rgba(255, 235, 235, 1)', 'rgba(180, 130, 100, 1)', 'rgba(170, 230, 170, 1)', 'rgba(100, 30, 30, 1)',
                                        'rgba(255, 160, 160, 1)', 'rgba(255, 255, 220, 1)', 'rgba(240, 200, 170, 1)', 'rgba(210, 255, 210, 1)', 'rgba(150, 210, 150, 1)'
