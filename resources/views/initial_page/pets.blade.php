<x-guest-layout>
    <div class=" flex justify-center">
        <div class="bg-red-900 w-full h-64">
            <h1>Banner siguro?</h1>
        </div>
    </div>
    <div class="bg-gray-100 max-w-fit ml-auto mr-auto"> 
        <div class="flex justify-center items-center pt-4">
            <h1 class="font-bold text-4xl">Find your partner</h1>
        </div>
        <div class="px-4 pt-4 w-full">
            <form class="flex lg:justify-end sm:justify-center">   
                <label for="default-search" class="col-span-2 mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
        ...
        <div class="lg:flex lg:justify-end px-6 py-4 gap-6 sm:grid sm:grid-cols-1">
        ...
        <div class="flex justify-center items-center px-6">
            <div class="grid lg:grid-cols-4 gap-6 sm:grid grid-cols-1">
                @foreach($pets as $pet)
