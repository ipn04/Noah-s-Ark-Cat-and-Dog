<x-guest-layout>
    <div class =  "bg-cover " style="background-image: url('{{ asset('images/redbackground.png') }}');">
        <div class = "animation grid grid-cols-1 lg:grid-cols-2  ">

            <div class = "flex items-center justify-end pt-10 lg:py-20 px-5">
                <div>
                    <h2 class = "text-white text-xl text-center md:text-left lg:text-3xl">Ready to change a life?</h2>
                    <h1 class= " lg:text-9xl text-6xl py-3 md:py-0 text-center md:text-left ">
                        <span class="text-white  font-bold">Be a</span>
                        <span class="text-yellow-500 font-bold">Hero!</span>
                    </h1>


                    <p class = "text-white font-normal text-base  text-center md:text-left  lg:text-xl">Adopting means our little survivors will be
                        gifted new
                        homes and hopes!</p>
        ...
        <div class = "grid grid-cols-1 lg:grid-cols-2 lg:py-20 py-8 px-10 lg:px-0">
            ...
            <div class = "flex items-center justify-center">
                <div class = "max-w-3xl py-5 px-10 lg:py-0">
                    <h1 class = "text-4xl lg:text-5xl  text-center py-2 lg:py-0 lg:text-left text-red-600 font-bold">
                        Noah's Ark Dog
                        and Cat Shelter
                    </h1>
    ...
    <div class =  "bg-cover md:mt-20 md:lg-20 mt-0 p-16" style="background-image: url('{{ asset('images/yellowbg.png') }}');">
        <div class = "animation">
            ...
            <div class = "flex items-center justify-center  pt-10">
                <div class = "grid-cols-1 lg:grid-cols-3 grid gap-5 md:gap-20">
                    <div>
                        <img class = "lg:max-w-sm lg:h-72 max-w-xs h-60 object-cover rounded-xl  hover:brightness-125 hover:opacity-90 cursor-pointer"
                            src="{{ asset('images/rescue.jpg') }}" alt="ark">
                        <h1 class = "lg:text-3xl text-2xl text-center py-4 text-white font-bold">Rescue</h1>
                    </div>
                    <div class = "lg:max-w-sm lg:h-72  max-w-xs h-60 mb-14 ">
                        <img class = "w-full h-full object-cover rounded-xl hover:brightness-110 hover:opacity-90 cursor-pointer" src="{{ asset('images/rehome.jpg') }}"
                            alt="ark">
                        <h1 class = "lg:text-3xl text-2xl text-center py-4 text-white font-bold">Rehabilitate</h1>
                    </div>
                    <div class = "lg:max-w-sm lg:h-72 max-w-xs h-60  mb-14  ">
                        <img class = "w-full h-full object-cover rounded-xl hover:brightness-110 hover:opacity-90 cursor-pointer"
                            src="{{ asset('images/rehabilitate.jpg') }}" alt="ark">
                        <h1 class = "lg:text-3xl text-2xl text-center py-4  text-white font-bold">Rehome</h1>
                    </div>
                </div>
            </div>
            <div class="text-center py-3">
                <p class="inline-block">
                    <span class="bg-white hover:bg-red-500 hover:text-white md:text-lg text-base cursor-pointer text-yellow-500 px-2 py-1">These three words are our shelter's essence, as we
    ...
    <div class =  "bg-cover p-16" style="background-image: url('{{ asset('images/redbackground.png') }}');">
        <div class = "animation">
            <h1 class = "text-4xl lg:text-5xl  text-center font-bold text-white">Embrace a Furry Friend</h1>
            <p class = "text-center text-base md:text-lg text-white py-4"> Browse our adorable adoptable pets and open your heart
                <br> to
                a lifelong companion today.</p>


            <div class="lg:py-4 py-5  mx-auto text-center lg:text-center">
                <a href="{{ route('pets') }}"
                        ...
                        @foreach ($pets as $pet)
                            <li class="card rounded-lg">
                                <a href = "{{ route('pet.desc', $pet->id) }}">
                                    <div class="w-full object-cover"><img class ="w-full object-cover rounded-lg h-72 "
                                            src="{{ asset('storage/images/' . $pet->dropzone_file) }}" alt="img"
                                            draggable="false"></div>
                                    <h2 class = "pt-2 text-center text-xl font-semibold text-red-500">
                                        {{ $pet->pet_name }}</h2>
                                    <p class = "text-center text-sm font-normal text-gray-400">{{ $pet->breed }} •
                                        {{ $pet->age }}yr/s</p>
                                </a>
                            </li>
                        @endforeach
    ...
    <div class = "animation grid-cols-1 lg:grid-cols-2 grid md:p-6 py-10 lg:py-20 lg:px-40">
        <div>
        ...
        <div class = "flex md:justify-end my-2 md:my-0 justify-center">
            <img class = "lg:max-w-md lg:h-80 max-w-xs h-60 object-cover rounded-xl hover:brightness-110 hover:opacity-90 cursor-pointer"
                src="{{ asset('images/volunteerprogram.jpg') }}" alt="ark">
        </div>
    </div>

    <div class = "animation grid-cols-1 lg:grid-cols-2 grid lg:py-20 py-10 lg:px-40">
        <div class = "flex md:justify-start order-2 md:order-1 justify-center">
            <img class = "lg:max-w-md lg:h-80 max-w-xs h-60 object-cover rounded-xl hover:brightness-110 hover:opacity-90 cursor-pointer"
                src="{{ asset('images/unleash.jpg') }}" alt="ark">
        </div>
        <div class = "flex justify-center items-center order-1 md:order-2 ">
            <div>
                <h1 class = "text-4xl py-2 lg:text-5xl text-red-600 font-bold text-center md:text-right">Unleash Support for Our Mission Online
                </h1>
                <p class = "md:text-right text-center text-lg md:ps-28  px-5 md:px-0 py-2">Your donation to our pet shelter helps provide shelter,
                    food,
