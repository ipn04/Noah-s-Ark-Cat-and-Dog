...
@if(  Route::is('user.notifications') ||  Route::is('interview.user') || Route::is('user.volunteerprogress') || Route::is('user.volunteer') ||Route::is('user.adoptionprogress') ||Route::is('user.adoption') || Route::is('user.pet') || Route::is('admin.adoptions') || Route::is('admin.volunteers') || Route::is('admin.schedule') || Route::is('profile.edit') || Route::is('user.dashboard') ||  Route::is('user.applications'))
lg:bg-transparent
@else
lg:bg-red-800
@endif">
