<x-app-layout>
    ...
    <section class="sm:ml-64 mb-5 dark:bg-gray-900 p-2 antialiased">
        <div class="flex flex-col sm:flex-row justify-between lg:items-center py-4 px-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 py-3 gap-3 lg:py-0 mx-auto lg:mx-0">
                <a href=""
                    class="hover:bg-white py-3 px-14 lg:p-3 w-full max-w-lg hover:text-green-500 font-bold bg-green-500 text-white rounded-lg shadow-md">Proceed to Next Steps</a>
                <a href=""
                    class="hover:bg-white py-3 px-14 lg:p-3 w-full max-w-lg text-center hover:text-red-500 font-bold bg-red-500 text-white rounded-lg shadow-md">Reject
                    Application</a>
            </div>
        </div>
