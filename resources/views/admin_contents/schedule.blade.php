        ...
        <div class="mx-auto max-w-screen-2xl px-4  lg:px-12">
            ...
            <div
                ...
                <table class=" w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($acceptedVisits as $visit)
                                ...
                                <tr
                                    ...
                                    <td scope="row"
                                        ...
                                        <img class="w-10 h-10 rounded-full"
                                            src="{{ asset('storage/' . $visit->application->user->profile_image) }}"
                                            alt="Pet Image">
                                        <div class="ps-2 flex flex-col">
                                            <div class="text-lg lg:text-base">{{ $visit->application->user->firstname }}
                                                {{ $visit->application->user->name }}</div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-base text-gray-500 ">{{ $visit->date }}</div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-base text-gray-500 ">{{ $visit->time }}</div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-red-600 w-24 rounded-lg py-1 font-semibold bg-red-200">
                                            <p class="text-center">{{ $visit->schedule->schedule_type }}</p>
                                        </div>
                        ...
                        @foreach ($acceptedPickups as $pickup)
                            @if ($pickup->schedule->schedule_status === 'Accepted')
                                <tr
                                    class="pet-container bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td scope="row"
                                        class="flex items-center px-5 py-4 font-medium text-slate-600 whitespace-nowrap dark:text-white">
                                        <img class="w-10 h-10 rounded-full"
                                            src="{{ asset('storage/' . $pickup->application->user->profile_image) }}"
                                            alt="Pet Image">
                                        <div class="ps-2 flex flex-col">
                                            <div class="text-lg lg:text-base">
                                                {{ $pickup->application->user->firstname }}
                                                {{ $pickup->application->user->name }}</div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-base text-gray-500 ">{{ $pickup->date }}</div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-base text-gray-500 ">{{ $pickup->time }}</div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-red-600 w-24 rounded-lg py-1 font-semibold bg-red-200">
                                            <p class="text-center">{{ $pickup->schedule->schedule_type }}</p>
                                        </div>
                        ...
                        @foreach ($acceptedInterviews as $interview)
                            @if ($interview->schedule->schedule_status === 'Accepted')
                                <tr
                                    class="pet-container bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td scope="row"
                                        class="flex items-center px-5 py-4 font-medium text-slate-600 whitespace-nowrap dark:text-white">
                                        <img class="w-10 h-10 rounded-full"
                                            src="{{ asset('storage/' . $interview->application->user->profile_image) }}"
                                            alt="Pet Image">
                                        <div class="ps-2 flex flex-col">
                                            <div class="text-lg lg:text-base">
                                                {{ $interview->application->user->firstname }}
                                                {{ $interview->application->user->name }}</div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-base text-gray-500 ">{{ $interview->date }}</div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-base text-gray-500 ">{{ $interview->time }}</div>
                                    </td>
                                    <td class="px-6 py-4  hidden lg:table-cell">
                                        <div class="text-red-600 w-24 rounded-lg py-1 font-semibold bg-red-200">
                                            <p class="text-center">{{ $interview->schedule->schedule_type }}</p>
                                        </div>
        ...
        <div class="mx-auto max-w-screen-2xl px-4 lg:py-4 lg:px-12">
            ...
            <div
                ...
                <table class=" w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($visits->where('schedule.schedule_status', '!=', 'Accepted') as $visit)
                            {{-- dito --}}
                            <tr
                                class="pet-container bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td scope="row"
                                    class="flex items-center px-5 py-4 font-medium text-slate-600 whitespace-nowrap dark:text-white">
                                    <img class="w-10 h-10 rounded-full"
                                        src="{{ asset('storage/' . $visit->user->profile_image) }}" alt="Pet Image">
                                    <div class="ps-2 flex flex-col">
                                        <div class="text-lg lg:text-base">{{ $visit->user->firstname }}
                                            {{ $visit->user->name }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4  hidden lg:table-cell">
                                ...
                                <td class="px-6 py-4  hidden lg:table-cell">
                                    <div class="text-red-600 w-24 rounded-lg py-1 font-semibold bg-red-200">
                                        <p class="text-center">{{ $visit->concern }}</p>
                                    </div>
                                </td>
                                <td class="items-center gap-1  hidden lg:table-cell">
                                    <button type="button"
                        ...
                        @foreach ($pickups->where('schedule.schedule_status', '!=', 'Accepted') as $pickup)
                            {{-- dito --}}
                            ...
                            <tr
                                ...
                                <td scope="row"
                                    ...
                                    <img class="w-10 h-10 rounded-full"
                                        ...
                                        alt="Pet Image">
                                    <div class="ps-2 flex flex-col">
                                        <div class="text-lg lg:text-base">{{ $pickup->application->user->firstname }}
                                            {{ $pickup->application->user->name }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4  hidden lg:table-cell">
                                ...
                                <td class="items-center gap-1  hidden lg:table-cell">
                                    <a
                                        href="{{ route('admin.adoptionprogress', ['id' => $pickup->application->user->id]) }}">
                                        <button
                                            class="py-2 px-3 text-sm font-medium text-center text-white bg-cyan-400 hover:bg-cyan-600 rounded-lg shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                fill="currentColor" class="w-4 h-4 ">
                        ...
                        @foreach ($interviews->where('schedule.schedule_status', '!=', 'Accepted') as $interview)
                            {{-- dito --}}
                            ...
                            <tr
                                ...
                                <td class="items-center gap-1  hidden lg:table-cell">
                                    <a
                                        href="{{ route('admin.adoptionprogress', ['id' => $interview->application->user->id]) }}">
                                        <button
                                            class="py-2 px-3 text-sm font-medium text-center text-white bg-cyan-400 hover:bg-cyan-600 rounded-lg shadow-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                fill="currentColor" class="w-4 h-4 ">
