    ...
    <section class="sm:ml-64 mb-5 dark:bg-gray-900 p-2 antialiased">
        ...
        <div class = "lg:px-10 lg:py-5 grid lg:grid-cols-4 grid-cols-1 gap-5 px-5 py-2 lg:gap-3 container">
            <div class="flex items-center justify-center">
              ...
              <div class="flex items-center justify-center">
                <button data-modal-target="static-modal" data-modal-toggle="static-modal" class="bg-white rounded-xl  py-5 px-10 shadow-md hover:shadow-lg hover:text-red-700 text-gray-500">
                  <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" data-slot="icon" class="w-12 h-12">
              ...
              <div class="flex items-center justify-center">
                <button data-modal-target="shelter-modal" data-modal-toggle="shelter-modal" class="bg-white rounded-xl  py-5 px-10 shadow-md hover:shadow-lg hover:text-red-700 text-gray-500">
                  <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" data-slot="icon" class="w-12 h-12">
        ...
        <div class="lg:px-10 lg:py-5 grid lg:grid-cols-4 grid-cols-1 gap-8 px-5 py-2 lg:gap-6container">
          @if($pets->isNotEmpty())
            @foreach($pets as $pet)
              <div class="h-fit group shadow-xl rounded-lg user-pet-lists" data-name="{{ $pet->pet_name }}" >
