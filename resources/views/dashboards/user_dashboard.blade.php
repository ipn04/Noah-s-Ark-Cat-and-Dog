<x-app-layout>
    ...
    <section class="sm:ml-64 mb-5 dark:bg-gray-900 p-2 antialiased">
        ...
        <div class = "mx-auto lg:px-10 lg:py-5 grid  lg:grid-cols-4 grid-cols-1 gap-5 px-5 py-2 lg:gap-4 container">
            ...
            <div class="flex items-center justify-center">
                <button data-modal-target="shelter-modal" data-modal-toggle="shelter-modal"
                    class="bg-white h-40  w-11/12 rounded-xl  py-5 px-10 shadow-md hover:shadow-lg hover:text-red-700 text-gray-500">
                    <div class="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" data-slot="icon"
                            class="w-12 h-12">
        ...
        <!-- Main modal -->
        <div id="shelter-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <gmp-map class="h-60" center="15.255250930786133,120.58500671386719" zoom="14"
                            map-id="DEMO_MAP_ID">
                    ...
                    <div class="flex items-center justify-center p-4 md:p-5 rounded-b ">
                        <a href="https://maps.app.goo.gl/dpLzdrgDLcGVobpk8" target="_blank"
                            class="text-white font-bold bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-md px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Open in Google Map
                        </a>
                    </div>
                </div>
