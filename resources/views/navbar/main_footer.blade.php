<footer class="bg-red-700 ">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-100  font-medium">
                      ...
                      <li class="mb-4">
                        <a href="https://tailwindcss.com/" class="hover:underline">Pets</a>
                    </li>
                    <li class="mb-4">
                        <a href="https://tailwindcss.com/" class="hover:underline">How can I Help</a>
                    </li>
                    <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Noah's Ark Dog and Cat Shelter</a>. All Rights Reserved.
          </span>
