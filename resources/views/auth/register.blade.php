    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="">
            <div class="items-center justify-center flex relative ">
                <img id='preview_img' class="h-60 w-60 object-cover border-4 rounded-full " src="https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-541.jpg?size=338&ext=jpg&ga=GA1.1.1546980028.1703116800&semt=ais" alt="Current profile photo" />
            
            </div>
            <div class="items-center justify-center flex mt-4 ">
                <label for="profile_image" class="bg-yellow-300 flex gap-2 font-bold hover:bg-yellow-200 py-2 px-4 rounded-md hover:cursor-pointer">
                ...
                <input id="profile_image" name="profile_image" type="file" style="visibility:hidden;" onchange="loadFile(event)" class="hidden"/>
                </label>
            </div>
        ...
        <div class="grid lg:grid-cols-3 grid-cols-1 gap-4 mt-4">
            <div>
                ...
                <select id="gender" name="gender" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 dark:focus:border-red-600 focus:ring-red-500 dark:focus:ring-red-600 rounded-md shadow-sm" required autocomplete="gender">
            ...
            <div>
                <x-input-label for="selected_date" :value="__('Birthday')" />
            ...
            <div>
                ...
                <select id="civil_status" name="civil_status" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 dark:focus:border-red-600 focus:ring-red-500 dark:focus:ring-red-600 rounded-md shadow-sm" required autocomplete="civil_status">
        ...
        <div class="mt-4">
            ...
            <textarea id="street" class="block mt-1 w-full  border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 dark:focus:border-red-600 focus:ring-red-500 dark:focus:ring-red-600 rounded-md shadow-sm" type="text" name="street" :value="old('street')" required autocomplete="street"></textarea>
        ...
        <div class="mt-4">
            ...
            <div class = "relative">
                ...
                <x-text-input id="phone_number" class="block mt-1 w-full ps-10" aria-describedby="helper-text-explanation" type="number" name="phone_number" :value="old('phone_number')" required autocomplete="number"  pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="965-621-6696" />
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2  mt-4 gap-3">
            <a class=" w-full bg-yellow-300  hover:bg-yellow-200 text-center py-2 font-bold rounded-lg" href="{{ route('login') }}">
                {{ __('Login') }}
            </a>
