        ...
        <div class="py-4 bg-red-800">
            ...
            <div class="grid grid-cols-1  p-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 px-8">
                ...
                <div class="flex p-6 bg-white shadow rounded-lg hover:shadow-md items-center">
                    ...
                    <div>
                        <p class="text-gray-700 text-xl font-semibold">Total Pets</p>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t dark:border-gray-700">
                    <div class="w-full md:w-1/2">
                        <form action="#" method="POST" role="search" class="flex items-center">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <div id="filterDropdown" class="z-50 hidden px-3 pt-1 bg-red-300 border-black border-2 rounded-lg shadow w-80 dark:bg-gray-700 right-0">
                    ...
                    <table id="petsTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody> 
                            @if($pets->isNotEmpty())
                                ...
                                @endforeach  
                            @else
                                <!-- Display a message or handle the case where there are no pets -->
                            @endif                         
                        </tbody>
                    </table>
                    {{-- <div>
