                            ...
                            data: {
                                ...
                                datasets: [{
                                    data: [{{ $dogCount }}, {{ $catCount }}],
                                     backgroundColor: [
                                        'rgba(252, 165, 165, 1)', 'rgba(253, 224, 71, 1)', 'rgba(110, 231, 183, 1)',
                                        'rgba(253, 186, 116, 1)',
                                        'rgba(248, 113, 113, 1)', 'rgba(250, 204, 21, 1)', 'rgba(52, 211, 153, 1)',
                                        'rgba(251, 146, 60, 1)',
                                        'rgba(239, 68, 68, 1)', 'rgba(234, 179, 8, 1)',
                                    ],
                                    borderColor: [
                                        'rgba(239, 68, 68, 1)', 'rgba(234, 179, 8, 1)', 'rgba(16, 185, 129, 1)',
                                        'rgba(249, 115, 22, 1)',
                                        'rgba(220, 38, 38, 1)', 'rgba(202, 138, 4, 1)', 'rgba(5, 150, 105, 1)',
                                        'rgba(234, 88, 12, 1)',
                                        'rgba(185, 28, 28, 1)', 'rgba(161, 98, 7, 1)',
