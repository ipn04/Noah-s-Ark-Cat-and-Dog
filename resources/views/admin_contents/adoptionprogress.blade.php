    ...
    <section class="sm:ml-64 mb-5 dark:bg-gray-900 p-2 antialiased">
        <div class="flex flex-col sm:flex-row justify-between lg:items-center py-4 px-10">
            ...
            <div class="lg:py-0 mx-auto lg:mx-0">
                <form action="{{ route('admin.updateStage', ['id' => $adoptionAnswer->id]) }}" method="POST" class="grid grid-cols-1 
                    ...
                    @csrf
                    @method('PATCH')
                    <button type="submit" class="hover:bg-white py-3 px-14 lg:p-3 w-full max-w-lg hover:text-green-500 font-bold bg-green-500 text-white rounded-lg shadow-md
                    @if($stage == 1 || $stage ==2 || $stage == 3)
                    hidden
                    @else
                    block
                ...
                <div class = "col-span-2 ">
                    <div class = "  mb-5 flex justify-center items-center">
                        <div class = "bg-white p-5 max-w-lg rounded-lg shadow-md">
                            <h2>Interview at 2023-13-11</h2>
                            <p>You have an interview scheduled later at 10:00am. Please join this meet later at 10:00 am</p>
                            <button class = "w-full bg-red-50">Join Meet</button>
                            <button class = "w-full bg-red-50">Wrap Interview</button>
                        </div>
                    </div>
        ...
        <div class = "hidden items-center  py-5  justify-center">
